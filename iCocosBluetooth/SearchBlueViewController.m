...
@interface SearchBlueViewController (){
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [DejalActivityView activityViewForView:self.view.window withLabel:@"链接中"];
    ...
    iCocosMainViewController *vc = [storyboard instantiateViewControllerWithIdentifier:@"iCocosMainViewController"];
...
//    iCocosMainViewController *vc = [[iCocosMainViewController alloc]init];
