...
//    //int i = 1;
//    Byte b0 = 0X05;
//    NSData *data0 = [NSData dataWithBytes:&b0 length:sizeof(b0)];
//    Byte b9 = 0Xff;
//    NSData *data9 = [NSData dataWithBytes:&b9 length:sizeof(b9)];
//    
//    [arrayData setObject:data0 atIndexedSubscript:0];
//    [arrayData setObject:data9 atIndexedSubscript:9];
//    
    Byte bi = 0X01;
    NSData *datai = [NSData dataWithBytes:&bi length:sizeof(bi)];
//
//    
//    for (int i = 1; i < 9; i++) {
//        [arrayData setObject:datai atIndexedSubscript:i];
//    }
//    
...
//    NSData *data = [NSKeyedArchiver archivedDataWithRootObject:arrayData];
    ...
    [self.currPeripheral writeValue:datai forCharacteristic:self.characteristic type:CBCharacteristicWriteWithResponse];
